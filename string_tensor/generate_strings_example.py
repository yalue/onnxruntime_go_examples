# This script generates "example_strings.onnx". This example takes a N-wide
# tensor of strings, and produces two N-wide outputs: one with the strings
# converted to lowercase and one with the strings converted to uppercase.
import numpy as np
import onnx
